...
REPO_NAME='mike-rodgers-site'
REPO_SLUG='mike-rodgers-site'
DEFAULT_BRANCH='main'
GITHUB_URL='https://github.com/rodgemd1-lgtm/mike-rodgers-site'
GITHUB_RAW_BASE='https://github.com/rodgemd1-lgtm/mike-rodgers-site/raw/main'
QNAP_CLONE='ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/mike-rodgers-site.git'
